...
CROP_INFO = {
    ...
    'coconut': {
        'description': 'Coconut palms thrive in tropical coastal areas with high humidity and consistent rainfall.',
        'ideal_conditions': 'N: 20-40, P: 10-30, K: 20-40, Temperature: 25-35°C, Humidity: 80-90%, pH: 5.5-7.0, Rainfall: 150-250mm'
    },
    'papaya': {
        'description': 'Papaya is a tropical fruit crop that grows rapidly in warm conditions. It needs well-drained soil and moderate rainfall.',
        'ideal_conditions': 'N: 80-110, P: 40-60, K: 30-50, Temperature: 25-40°C, Humidity: 20-60%, pH: 6.0-7.0, Rainfall: 100-200mm'
    },
    'orange': {
    ...
    'muskmelon': {
        'description': 'Muskmelon is a warm-season crop that requires well-drained soil and moderate rainfall.',
        'ideal_conditions': 'N: 20-40, P: 30-50, K: 30-50, Temperature: 20-30°C, Humidity: 60-80%, pH: 6.0-7.0, Rainfall: 60-100mm'
    },
    'watermelon': {
    ...
    'pomegranate': {
        'description': 'Pomegranate trees are drought-tolerant and thrive in hot, dry summers and mild winters.',
        'ideal_conditions': 'N: 20-40, P: 20-40, K: 20-40, Temperature: 15-35°C, Humidity: 40-70%, pH: 5.5-7.0, Rainfall: 50-100mm'
    },
    'lentil': {
        'description': 'Lentil is a cool-season pulse crop that fixes nitrogen in the soil. It has moderate water requirements.',
        'ideal_conditions': 'N: 20-40, P: 40-60, K: 20-40, Temperature: 15-25°C, Humidity: 40-70%, pH: 6.0-7.0, Rainfall: 60-100mm'
    },
    'blackgram': {
        'description': 'Blackgram (urad dal) is a pulse crop that grows in warm, humid conditions. It has moderate water needs.',
        'ideal_conditions': 'N: 20-40, P: 40-60, K: 20-40, Temperature: 25-35°C, Humidity: 60-80%, pH: 6.0-7.5, Rainfall: 60-100mm'
    },
    'mungbean': {
        'description': 'Mungbean is a drought-tolerant pulse crop that grows in warm conditions with minimal water.',
        'ideal_conditions': 'N: 20-40, P: 40-60, K: 20-40, Temperature: 25-35°C, Humidity: 60-80%, pH: 6.0-7.5, Rainfall: 60-100mm'
    },
    'mothbeans': {
        'description': 'Mothbean is an extremely drought-tolerant pulse crop suitable for arid and semi-arid regions.',
        'ideal_conditions': 'N: 20-40, P: 40-60, K: 20-40, Temperature: 25-35°C, Humidity: 30-60%, pH: 6.0-8.0, Rainfall: 30-60mm'
    },
    'pigeonpeas': {
        'description': 'Pigeonpea (toor dal) is a drought-resistant pulse crop that grows in a variety of soils and climates.',
        'ideal_conditions': 'N: 20-40, P: 40-60, K: 20-40, Temperature: 20-35°C, Humidity: 60-80%, pH: 6.0-7.5, Rainfall: 60-140mm'
    },
    'kidneybeans': {
        'description': 'Kidney beans grow in warm, humid conditions with well-drained soil and moderate rainfall.',
        'ideal_conditions': 'N: 20-40, P: 40-60, K: 20-40, Temperature: 20-30°C, Humidity: 60-80%, pH: 6.0-7.0, Rainfall: 60-110mm'
    },
    'chickpea': {
